        ...
        <div class="point-links">
            <div class="point-link">
                ...
                <div>
                    ...
                    <div class="point-description">
                        Деревья – это один из важнейших компонентов для создания атмосферы и структуры ландшафтного
                        дизайна.
                        Поэтому с целью достижения определенного результата, специалисты рекомендуют обращать внимание
                        на
            ...
            <div class="point-link">
                ...
                <div>
                    ...
                    <div class="point-description">
                        В данной инструкции отражены особенности выбора формованных деревьев. Вы получите всю
                        информацию,
            ...
            <div class="point-link">
                ...
                <div>
                    ...
                    <div class="point-description">
                        ...
                        сохранению биоразнообразия и созданию природных арт-объектов. Поддержите инициативу заказа
                        деревьев
