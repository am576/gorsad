    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <section class="page-bg col-md-12 p-0">
                <div class="knowhow-img-main" style="background-image: url('/storage/images/public/knowhow/topiary_bg.jpg'); ">
                    <h1 class="knowhow-title" style="">Топиарные и формованные виды деревьев</h1>
                </div>
            </section>
            ...
            <section class="page-content w-100">
                <div class="container pt-5 pb-5">
                    ...
                    <a href="">Просмотреть инструкцию о Топиарных Деревьях</a>
                </div>
                <div class="container pb-5">
                    ...
                    <a href="">Просмотреть инструкцию о Формованных Деревьях</a>
                </div>
                <div class="container">
                    <div class="d-flex">
